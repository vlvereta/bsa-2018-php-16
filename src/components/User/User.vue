  ...
  <div>
    ...
    <div class="user-form-wrp">
      <div class="user-form">
        ...
        <div class="buttons">
          <button @click="$router.push({ name: 'users' })" class="btn btn-primary">Users</button>
          <button @click="$router.push({ name: 'user-albums', params: { id: $route.params.id } })" class="btn btn-success">Albums</button>
